...
jQuery(document).ready(function () {
  ...
  krimi_app.MainView = Backbone.View.extend({
    ...
    events: {
      ...
      'click #krimi_same_main_char_button': 'Show_characters',
      'click #krimi_same_location_button': 'Show_locations',
    },
    ...
    Show_locations: function () {
      krimi_app.locations_rdf.fetch_rdf({
        success: function () {
          krimi_app.show_location_items.render();
        }
      }, Drupal.settings.oc_krimi_siden.faust);

    },
    Show_characters: function () {
      krimi_app.characters_rdf.fetch_rdf({
        success: function () {
  ...
  krimi_app.books_with_similar_character_rdf = new krimi_app.books_with_similar_character_rdf();
  krimi_app.books_with_similar_location_rdf = new krimi_app.books_with_similar_location_rdf();
  krimi_app.locations_rdf = new krimi_app.locations_rdf();
  krimi_app.characters_rdf = new krimi_app.characters_rdf();
  ...
  krimi_app.SimilarBooksbyCharacter = new krimi_app.SimilarBooksbyCharacter();
  krimi_app.SimilarBooksbyLocation = new krimi_app.SimilarBooksbyLocation();
  krimi_app.show_location_items = new krimi_app.show_location_items();
  krimi_app.show_character_items = new krimi_app.show_character_items();
